...
export class DesafiosService {
    ...
    async criarDesafio(criarDesafioDto: CriarDesafioDto): Promise<IDesafio> {
        ...
        const solicitanteEhJogadorDaPartida = criarDesafioDto.jogadores.filter(jogador => jogador.toJSON() == criarDesafioDto.solicitante)
        ...
        const categoriaDoJogador = await this.categoriasService.consultarCategoriaJogador(criarDesafioDto.solicitante)
