  ...
  list: {
    ...
    */
    api: {
      ...
      |
      | The foreignKey column is used to make the relationship between the application
      ...
      */
      ...
      provider: {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Uids are used to search a application against one of the mentioned columns. During
        | login, the auth module will search the application mentioned value against one
        | of the mentioned columns to find their application record.
        |
        */
        uids: ['email'],
        ...
        |--------------------------------------------------------------------------
        |
        | The model to use for fetching or finding applications. The model is imported
        | lazily since the config files are read way earlier in the lifecycle
        | of booting the app and the models may not be in a usable state at
        | that time.
        |
        */
        model: () => import('App/Models/Application'),
      },
    },
  },
}
